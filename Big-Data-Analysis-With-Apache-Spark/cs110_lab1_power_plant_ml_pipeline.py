# Databricks notebook source exported at Fri, 16 Dec 2016 23:04:37 UTC
# MAGIC %md
...
dataDF = rawTextRdd.map(lambda x: (x, ))
display(dataDF.take(5))

dataDFq = rawTextRdd.map(lambda x: x.split("\t"))
display(dataDFq.take(5))
