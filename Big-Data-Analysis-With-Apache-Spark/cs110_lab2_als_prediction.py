# Databricks notebook source exported at Fri, 16 Dec 2016 23:04:49 UTC
# MAGIC %md
...
print movie_names_with_avg_ratings_df.dtypes
...
my_rated_movies = [
     (0,318,5),(0,858,5),(0,527,5),(0,1221,5),(0,2019,5),(0,912,4),(0,1203,5),(0,1213,5),(0,94466,4),(0,593,5)
...
predicted_with_counts_df = predicted_ratings_df.join(movie_names_with_avg_ratings_df, predicted_ratings_df.movieId == movie_names_with_avg_ratings_df.movieId).drop(movie_names_with_avg_ratings_df.movieId).drop(movie_names_with_avg_ratings_df.title)
